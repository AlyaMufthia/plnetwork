    ...
    <style>
        * {
        ...
        .foto-badge {
            ...
            top: 10px;
            left: 10px;
            background: rgba(23, 58, 132, 0.85);
            color: #fff;
            font-size: 10px;
            font-weight: 600;
            padding: 3px 8px;
        ...
        .log-foto-view-btn:hover {
            color: #173a84;
            text-decoration: underline;
        }

        .log-foto-view-btn svg {
            width: 15px;
            height: 15px;
            stroke: currentColor;
            fill: none;
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('inputgangguan.index') }}"
                class="nav-item {{ request()->routeIs('inputgangguan.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('laporan.index') }}"
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M3 3v18h18" />
                    <path d="M18.7 8.3 14 13l-3-3-4.7 4.7" />
                </svg>
                Laporan
            </a>
        </nav>
                        ...
                        @forelse($gangguan->logs->sortBy('id') as $log)
                            <div class="timeline-item">
                                ...
                                <div class="timeline-title {{ $loop->last ? 'active' : '' }}"
                                    ...
                                    <button type="button" class="log-foto-view-btn"
