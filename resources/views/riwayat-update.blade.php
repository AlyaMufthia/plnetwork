                ...
                <div class="left-col">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="step-row" id="stepRow">
                                @foreach(['Down','Persiapan','Mobilisasi','Eksekusi','Up'] as $idx => $label)
                                    @php $n = $idx + 1; @endphp
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="logContainer">
                            ...
                            @php
                                $tahapanLabelsPhp = ['','Down','Persiapan','Mobilisasi','Eksekusi','Up'];
                            @endphp
...
<script>
    ...
    const tahapanLabels = ['', 'Down', 'Persiapan', 'Mobilisasi', 'Eksekusi', 'Up'];
